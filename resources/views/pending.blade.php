...
<html lang="en">
<head>
<title>{{ __('Pending') }} - {{ $allsettings->site_title }}</title>
@include('meta')
@include('style')
</head>
<body>
...
<div @if($custom_settings->theme_layout == 'container') class="container-fluid py-5 mt-md-2 mb-2" @else class="container py-5 mt-md-2 mb-2" @endif>
      <div class="row">
        <div class="col-lg-12">
          <div class="font-size-md text-center"><h2 class="h4 pb-3">{{ __('Your payment transaction was pending. Thank You') }}!</h2></div>
         </div>
      </div>
    </div>
@include('footer')
