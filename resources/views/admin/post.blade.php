                                ...
                                <table id="example" class="table table-striped table-bordered">
                                    ...
                                    @foreach($postData['post'] as $post)
                                        <tr class="allChecked">
                                            ...
                                            <td>{{ $no }}</td>
                                            <td>{{ mb_substr($post->post_title, 0, 50, 'UTF-8') }} </td>
                                            ...
                                            @else
                                            <a href="{{ url('/admin') }}/post/{{ $post->post_id }}" class="btn btn-danger btn-sm" onClick="return confirm('Are you sure you want to delete?');"><i class="fa fa-trash"></i>&nbsp;{{ __('Delete') }}</a>@endif</td>
                                        </tr>
        ...
        buttons: [
                {
					...
					className: 'ml-4 mr-1',
					filename: '{{ $allsettings->site_title }} - Post'
                },
                {
                    extend: 'csv',
                    exportOptions: {
