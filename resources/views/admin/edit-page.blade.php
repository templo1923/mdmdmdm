                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="textboxdata" name="page_title" type="text" class="form-control" value="{{ $edit['page']->page_title }}" data-bvalidator="required">
                                            </div>
                                            
                                             <div class="form-group">
                                                <label for="site_desc" class="control-label mb-1">{{ __('Description') }}<span class="require">*</span> @if(View::exists('aiwriter::index')) @if(in_array('edit-page',$ai_writer_display_pages))@include('aiwriter::aigenerate')@endif @endif</label>
