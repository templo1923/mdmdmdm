...
class Blog extends Model
{
  ...
  public static function homelogoData()
  {
     $value=DB::table('development_logo')->where('logo_status','=',1)->orderBy('logo_order', 'asc')->get(); 
    return $value;
  }	
  ...
  public static function editsingleCount($slug){
    $get = DB::table('post')->join('blog_category','blog_category.blog_cat_id','post.blog_cat_id')->where('post.post_slug', $slug)->get();
	$value = $get->count(); 
    return $value;
  } 
  ...
  public static function homepostData($take)
  {

    $value=DB::table('post')->join('blog_category','blog_category.blog_cat_id','post.blog_cat_id')->where('post.post_status','=',1)->orderBy('post.post_id', 'desc')->take($take)->get(); 
    return $value;
  ...
  public static function insertpostData($data){
	...
	public static function deleteall_blog_category($id)
	{
  ...
  public static function getgroupcommentData()
  {
    ...
    /*$value=DB::table('post_comment')->join('users','users.id','post_comment.user_id')->where('post_comment.comment_status','=',1)->orderBy('post_comment.comment_id', 'desc')->get()->groupBy('post_comment.post_id'); 
    return $value;*/
