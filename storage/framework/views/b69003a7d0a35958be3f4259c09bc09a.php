...
.custom-form-check-input {
  ...
  opacity: 1;
  appearance: none;
  border: 1px solid <?php echo e($allsettings->site_button_color); ?>;
  border-radius: 3px;
  background: #fff;
  position: relative;
  top:4px;
...
.custom-form-check-input:checked {
  border: 2px solid <?php echo e($allsettings->site_button_color); ?>;
  background: <?php echo e($allsettings->site_button_color); ?>;
}
</style><?php /**PATH F:\xampp\htdocs\downgrade\resources\views/dynamic.blade.php ENDPATH**/ ?>